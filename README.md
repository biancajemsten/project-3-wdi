...
**Done**
The initial search bar has now been replaces with a submit button which the user can click when they are happy with their bundle. It sends a POST request with all the data of the bundle and redirects of the showpage of that bundle. 
